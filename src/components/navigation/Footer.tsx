      ...
      <div className="max-w-7xl mx-auto px-6 pt-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-500 text-sm font-medium">Sistem Informasi - Universitas Pamulang</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <a 
              ...
              className="group flex items-center gap-2 bg-linear-to-tr from-yellow-400 via-red-500 to-purple-600 p-0.5 rounded-xl transition-transform hover:scale-110 active:scale-95"
            >
          ...
          <div className="text-center md:text-right">
            <p className="text-slate-500 text-sm">
              &copy; {year} Dibuat oleh <span className="font-semibold text-indigo-600">01SIFP009</span>
            </p>
